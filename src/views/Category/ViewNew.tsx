                ...
                {categoryData => {
                  ...
                  return (
                    <>
                      <MetaWrapper
                        meta={{
                          description: category.data.category.seoDescription ? category.data.category.seoDescription : `${category.data.category.name} | Planet Caravan | Cincinnati, Oh`,
                          title: category.data.category.seoTitle ? category.data.category.seoTitle : `${category.data.category.name} | Planet Caravan | Cincinnati, Oh`,
